...
const CutOptimizerAlgorithm = ({ setOpacity }) => {
    ...
    const optimizedsShapes = cut_opt.optimize(shapes, { width: SHEET_WIDTH, height: SHEET_HEIGHT, items: shapes });
                        ...
                        }} className="cut-layout" >
                            {
                                sheet.items.map((item, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <button className='rotateBtn'><img src={ROTATE} alt="Rotate" className='rotateImg' /></button>
